...
def test_sprat_manual_atlas():
    ...
    best_p, _, _, rms, residual, peak_utilisation, atlas_utilisation = c.fit(max_tries=250)
    ...
    c.plot_search_space(
        ...
        fig_type="png+html",
        save_fig=True,
        filename=os.path.join(HERE, "test_output", "test_lt_sprat_search_space_matplotlib"),
    )
