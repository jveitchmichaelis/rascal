...
c.plot_arc(
    save_fig="png",
    display=False,
    filename="output/gtc-osiris-manual-atlas-arc-spectrum",
)
...
c.plot_fit(
    ...
    display=False,
    save_fig="png",
    filename="output/gtc-osiris-manual-atlas-wavelength-calibration",
)
...
c.plot_search_space(
    save_fig="png", filename="output/gtc-osiris-manual-atlas-search-space"
)
